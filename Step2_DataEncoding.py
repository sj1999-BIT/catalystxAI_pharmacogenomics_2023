...
class DataEncoding:
    ...
    def encode(self,traindata,testdata):
        ...
        train_rnadata, test_rnadata, pop_train_index, pop_test_index = self.Getdata.getRna(
            traindata=traindata,
            testdata=testdata)
        print(len(train_rnadata))
        print(pop_train_index)

        traindata.drop(pop_train_index, inplace=True)
        testdata.drop(pop_test_index, inplace=True)
